...
urlpatterns = [
    ...
    re_path(
        r'^(?P<article_id>\d+)/authors/(?P<author_id>\d+)/organization/search/$',
        views.OrganizationListView.as_view(),
        name='organization_search'
    ),
    re_path(
        r'^(?P<article_id>\d+)/authors/(?P<author_id>\d+)/organization_name/create/$',
        views.OrganizationNameCreateView.as_view(),
        name='organization_name_create'
    ),
    re_path(
        r'^(?P<article_id>\d+)/authors/(?P<author_id>\d+)/organization_name/(?P<organization_name_id>\d+)/update/$',
        views.OrganizationNameUpdateView.as_view(),
        name='organization_name_update'
    ),
    re_path(
        r'^(?P<article_id>\d+)/authors/(?P<author_id>\d+)/organization/(?P<organization_id>\d+)/affiliation/create/$',
        views.AffiliationCreateView.as_view(),
        name='affiliation_create'
    ),
    re_path(
        r'^(?P<article_id>\d+)/authors/(?P<author_id>\d+)/affiliation/(?P<affiliation_id>\d+)/delete/$',
        views.AffiliationDeleteView.as_view(),
        name='affiliation_delete'
    ),
    re_path(
        r'^(?P<article_id>\d+)/authors/(?P<author_id>\d+)/affiliation/(?P<affiliation_id>\d+)/update/$',
